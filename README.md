...
**_KDT3rd Group D_ I ** 김재란 김현아 신진영 염정호\*\*
...
_‘Dice’_ 주사위를 굴리는 것처럼 D.NEMA에서 영화를 골라준다는 의미입니다.
...
_(Action, Romance, Comedy, SF 총 4개 장르\_ 예시 사진은 Action)_
...
_D조가 개발한 D.NEMA 서비스를 보고 코멘트를 남겨주세요!_
